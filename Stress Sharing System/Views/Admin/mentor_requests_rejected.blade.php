                        ...
                        <div class="white_shd full margin_bottom_30">
                         <div class="full graph_head">
                            <div class="heading1 margin_0">
                               <h2><a href="{{url('ADMIN/MentorRequests')}}"><span>Pending</span></a>
                                <a href="{{url('ADMIN/MentorRequests/Approved')}}">Approved</a>
                                <a class="requests_type" href="#">Rejected</a></h2>
                            </div>
                         </div>
                           <style>
                            .padding_infor_info{
                           ...
                           <div class="full price_table padding_infor_info">
                              <div class="row">
                                @if (count(App\Http\Controllers\admin::mentor_requests(0,1))==0)
                                 ...
                                 <div class="col-lg-12">
                                    <div class="table-responsive-sm">
                                       <table class="table table-striped projects">
                                          ...
                                          <tbody>
                                            @foreach (App\Http\Controllers\admin::mentor_requests(0,1) as $request)
                                             ...
                                             <tr>
                                                ...
                                                <td class="btns_con">
                                                  <input type="hidden" value="{{$request->email}}">
                                                   <button type="button"  class="undo_rejected">Undo</button>
                                                   <button type="button"  class="remove_rejected">Remove</button>
                                                </td>
                                             </tr>
