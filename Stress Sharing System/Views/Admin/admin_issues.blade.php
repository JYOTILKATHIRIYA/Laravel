...
<html lang="en">
   ...
   <body class="dashboard dashboard_1">
                    ...
                    <div class="white_shd full margin_bottom_30" >
                              ...
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    <h2>Issues in help</h2>
                                    <div id="add_new_issue"> 
                                       <input type="text" placeholder="New Issue"><button>Add new Issue</button>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="table_section padding_infor_info"  style="width: 100%;">
                                 <div class="table-responsive-sm" style="width: 100%;">
                                    <table class="table table-contextual" style="width:100%;font-size:16px;" >
                                       ...
                                       <tbody id="table_body" style="font-weight: 500">
                                        @foreach (App\Http\Controllers\admin::get_issues_data() as $issue)
                                            
                                          <tr>
                                             <td style="text-align: center">{{$issue->id}}</td>
                                             <td><input type="text" value=" {{ucwords(str_replace("_"," ", strtolower($issue->issue)) )}} " disabled></td>
                                             <td style="text-align: center"><a href='{{url("/ADMIN/Mentors/$issue->id")}}'>{{$issue->mentors}}</a></td>
                                             <td style="text-align: center"><a>{{$issue->users}}</a></td>
      ...
      <script src="{{URL::asset('/js/Admin/admin_issues.js')}}"></script>
